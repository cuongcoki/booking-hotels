      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2 px-3 py-2 rounded-2xl bg-gray-200">
        ...
        >
          ...
          <button
            ...
            active:scale-95 md:px-25 py-3 md:py-4 text-base cursor-pointer
            "
          >
            Check Availability
          </button>
        ...
        hover:bg-primary-dull transtion-all cursor-pointer
        ">Contact Now</button>
      </div>
    )
  );
