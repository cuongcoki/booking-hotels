...
const CheckBox = ({label,selected =false,onChange = () =>{}}) =>{
    return(
        <label className="flex gap-3 items-center cursor-pointer mt-2 text--sm">
            <input type="checkbox" checked={selected} onChange={(e) =>onChange(e.target.checked, label)} className="w-5 h-5" />
    ...
    return(
        <label className="flex gap-3 items-center cursor-pointer mt-2 text--sm">
            <input type="radio" name="sortOption" checked={selected} 
             onChange={() =>onChange(label)} className="w-5 h-5" />
            <span className="font-light select-none">{label}</span>
        </label>
    )
}
...
const AllRoom = () => {
  ...
  const roomTypes = ["Single Bed", "Double Bed", "Luxury Room", "Famly Suite"];
    ...
    >
      <div>
        <div>
          ...
          <p className="text0sm md:text-base text-gray-500/90 mt-2 max-w-174">
            Take adventage of out limited-time offers and special packages to
            ...
            >
              ...
              <div className="md:w-1/2 flex flex-col gap-2">
                ...
                <div className="flex items-center">
                  <StarRating />
                  <p className="ml-2">200+ revires</p>
                </div>
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
        ...
        >
          <div className="px-5 pt-5">
           ...
           <div className="px-5 pt-5">
            <p className="font-medium text-gray-800 pb-2">Prive Range</p>
